...
<div class="w-full flex justify-between items-center p-4 rounded-lg gap-4 border-1 border-[#EBEBE8] mb-2">
    ...
    <div  class="text-sm text-[#818181] font-medium pl-2 w-[25%] flex items-center gap-4">
        ...
        <!-- username and email -->
        <div class="text-xs">
        <p class="text-[#443C68] font-medium">andrei.mayo</p>
        <p class="text-[#A5A4A1]">andrei.mayo@gmail.com</p>
        </div>
    </div>
    <!-- message -->
    <div class="text-xs text-[#443C68] w-[30%] font-medium p-3 rounded-lg bg-[#ebebe8]/50 truncate">
        Reminder. You have a meeting with the client at 3:00 PM. Please be on time.
    </div>
    <!-- status -->
    <div class="text-xs text-[#6C9B7D] font-medium w-[15%] bg-[#DBEDDB]/50 p-3 text-center rounded-lg ml-10">
        Sent
    </div>
    <!-- date sent -->
    ...
    <!-- recipeint -->
    <div class="w-[15%] bg-[#443c681c] p-3 rounded-lg text-center">
        <p class="text-xs text-[#443C68] font-medium">
            24 recipients
        </p>
    </div>
</div>
